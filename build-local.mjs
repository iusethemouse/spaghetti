...
function strip(source) {
  return source
    ...
    .replace(/^if \(!process\.env\.SPAGHETTI_EMBED\) start\(\);\n?/m, '');
}

const web = await assets();
web['api.js'] = await readFile(join(ROOT, 'server', 'api.js'), 'utf8');
...
// spaghetti ${version}
// One file. It needs Node 18 or newer and the GitHub CLI, and nothing else.
// Run it: ./spaghetti.mjs   or   node spaghetti.mjs
